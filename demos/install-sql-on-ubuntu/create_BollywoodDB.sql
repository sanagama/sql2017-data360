 ...
 *
 */
ALTER DATABASE [BollywoodDB] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
GO
...
-- Dump Actor records - note that everyone can see the Email and PhoneNumber
SELECT [FirstName], [LastName], [Email], [MobileNumber] FROM Actors;
GO
