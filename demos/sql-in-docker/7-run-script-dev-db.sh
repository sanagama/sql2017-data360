...
sqlcmd -S localhost,1432 -U sa -P Yukon900 -Q "SELECT name from sys.databases"

# Execute generated script on 'sqldocker-dev' at port 1432
# This creates the AdventureworksLT database schema
sqlcmd -S localhost,1432 -U sa -P Yukon900 -i ./create-customer.sql
...
sqlcmd -S localhost,1432 -U sa -P Yukon900 -d AdventureworksLT \
